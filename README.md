# Thư Ký Mẫn Nhi - Streamlit Application

## 📝 Description
A Streamlit-based web application featuring a customized pink theme interface. [Add a brief description of what your application does]

## ✨ Features
- Custom pink theme interface
- [List your main features]
- [Add more features]

## 🎨 Theme Customization
The application uses a custom pastel pink theme with the following color scheme:
- Primary Color: Pastel Pink (#f48fb1)
- Background Color: Lavender Blush (#fff0f5)
- Secondary Background: Light Pink (#f8bbd0)
